	...
	<div class="main container">
            ...
            <div class="main-a row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                    <p>
                        <img src="imges/453254312.png">${num}<br>
                ...
                <ul class="list-unstyled text-center">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            ...
                            <p class="text-left">${list[0].getJob()}</p>
                        </div>
                    </li>
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            ...
                            <p class="text-left">${list[1].getJob()}</p>
                        </div>
                    </li>
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            ...
                            <p class="text-left">${list[2].getJob()}</p>
                        </div>
                    </li>
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            ...
                            <p class="text-left">${list[3].getJob()}</p>
                        </div>
                    </li>
                </ul>
            </div>
